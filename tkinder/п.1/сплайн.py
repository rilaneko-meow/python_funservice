...
spline = canvas.create_line(170,20,200,140,50,30,80,150,width=21,fill='black',smooth=True)
line = canvas.create_line(170,20,200,140,50,30,80,150,width=3,fill='red')
